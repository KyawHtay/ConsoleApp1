...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var priceEngine = new PriceEngine(new QuotationSystem(123.45M, true, "Test Name", 0.12M),
                                              new QuotationSystem(234.56M, true, "qewtrywrh", 0.12M),
                                              new QuotationSystem(92.67M, true, "zxcvbnm", 0.12M));
